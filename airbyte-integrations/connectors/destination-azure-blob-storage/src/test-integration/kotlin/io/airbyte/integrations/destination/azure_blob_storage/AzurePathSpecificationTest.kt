...
class AzurePathSpecificationTest {
    ...
    fun testPathPatternDefaultWhenNull() {
        val config =
            AzureBlobStorageConfiguration<BufferedOutputStream>(
                mockk(),
                mockk(),
                mockk(),
                pathFormat = null
        ...
        assertEquals(
            AzureBlobStorageConfiguration.DEFAULT_PATH_PATTERN,
            config.objectStoragePathConfiguration.pathPattern
        )
    }
    ...
    fun testPathPatternNormalizesLowercaseBraces() {
        val config =
            AzureBlobStorageConfiguration<BufferedOutputStream>(
                ...
                mockk(),
                mockk(),
                pathFormat = "{namespace}/{stream_name}/{year}/"
            )
        assertEquals(
            "\${NAMESPACE}/\${STREAM_NAME}/\${YEAR}/",
            config.objectStoragePathConfiguration.pathPattern
        )
    }
    ...
    fun testPathPatternNormalizesMixedCase() {
        val config =
            AzureBlobStorageConfiguration<BufferedOutputStream>(
                ...
                mockk(),
                mockk(),
                pathFormat = "\${Namespace}/\${Stream_Name}/"
            )
        assertEquals(
    ...
    fun testPathPatternPassesThroughAlreadyCorrectFormat() {
        val config =
            AzureBlobStorageConfiguration<BufferedOutputStream>(
                ...
                mockk(),
                mockk(),
                pathFormat = "\${NAMESPACE}/\${STREAM_NAME}/\${YEAR}/\${MONTH}/\${DAY}/"
            )
        assertEquals(
    ...
    fun testFileNamePatternDefaultWhenNull() {
        ...
        assertEquals(
            AzureBlobStorageConfiguration.DEFAULT_FILE_NAME_PATTERN,
            config.objectStoragePathConfiguration.fileNamePattern
        )
    }
    ...
    fun testFileNamePatternTrimmed() {
        val config =
            AzureBlobStorageConfiguration<BufferedOutputStream>(
                ...
                mockk(),
                mockk(),
                fileNamePattern = "  {date}_{part_number}{format_extension}  "
            )
        assertEquals(
            "{date}_{part_number}{format_extension}",
            config.objectStoragePathConfiguration.fileNamePattern
        )
    }
}
